...
_REGIME_POS_LIMIT: dict[str, float] = {
    # ★[BUG-FIX-POS] 原仓位限制过于保守，导致长期收益被压制
    # 特别是 BEAR=0.0 会导致完全空仓，错过反弹行情
    "STRONG_BULL": 1.0,
    "BULL"       : 1.0,   # 0.8→1.0，牛市允许满仓
    "NEUTRAL"    : 0.9,   # 0.8→0.9，震荡市更积极
    "SOFT_BEAR"  : 0.7,   # 0.6→0.7，软熊允许七成仓
    "BEAR"       : 0.3,   # 0.0→0.3，★关键修复：熊市保留底仓，避免完全踏空反弹
}
